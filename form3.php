...
<div style="margin-top: 80px;margin-bottom: 10px; border:0px; border-color: white;" align="center">
           ...
           <form name="signin" id="form2" class="animate"  action="action_page.php" method="post"> 


      <input type="text" autofocus="autofocus" class="manage" style="padding-left:10px;" style="margin-top:20px; " placeholder="Enter Full Name *" name="name" required>
	<br><br>

	<input  type="number" class="manage" style="padding-left:10px;" max="90" placeholder="Age *" name="pas" required>
	<br><br>
...
<br><br>
      ...
      <input  type="text" class="manage" style="padding-left:10px;" size="300" placeholder="address *" name="pas" required><br><br>
      <input  type="number" maxlength="6" class="manage" style="padding-left:10px;"  placeholder="pin" name="pas"><br><br>      
...
<input  type="number" maxlength="10" class="m"  placeholder="contact number" name="pas" required style="width:399px;padding-left:10px;">
</div>
	<br><br>

      <input type="text" class="manage" style="padding-left:10px;"  placeholder="disease to be diagnosed" name="rpas" required >
<br><br>
<div>
...
<select name="docs" id="docs"  class="manage" style="padding-left:10px;" required class="text-muted">
<option value="" >which doctor you would like to choose</option>
<option value="fi">a</option>
<option value="ff">b</option>
<option value="fd">c</option>
<option value="fiad">d</option>
<option value="fias\da">e</option>
<option value="fw">f</option>
</select></div>
</div>


	  	<br><br>
	  	<input  type="text" class="manage" style="padding-left:10px;"  placeholder="allergic to any medicine" name="pas" required>
	<br><br>
	...
	<br><br>
	  ...
	  <input id="dateofbirth" type="Date" class="manage" style="padding-left:10px;"  placeholder="date of birth" name="dob" onmouseover="return validatePass()" required>
...
<input type="checkbox" checked="checked"> Remember me
      ...
      <p>By creating an account you agree to our <a href="#">Terms & Privacy</a>.</p>
        ...
        <button type="submit" class="signupbtn btn-success round w-100" >Register</button>
